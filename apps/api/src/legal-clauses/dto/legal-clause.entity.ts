...
export class ContractLegalClause {
  ...
  // ========== 终止与争议条款 ==========
  @Field({ nullable: true, description: '便利终止通知期（如"30天"、"60天"）' })
  terminationNotice?: string | null;

  @Field({ nullable: true, description: '违约责任描述' })
  breachLiability?: string | null;

  @Field({ nullable: true, description: '争议解决方式（ARBITRATION/LITIGATION/NEGOTIATION）' })
  ...
  @Field({ nullable: true, description: '原始文本引用（用于溯源）' })
